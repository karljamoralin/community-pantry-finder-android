    ...
    class PermissionDeniedDialog : DialogFragment() {
        ...
        override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
            ...
            return AlertDialog.Builder(activity)
                .setMessage(R.string.location_access_rationale)
        ...
        override fun onDismiss(dialog: DialogInterface) {
            ...
            if (finishActivity) {
                Toast.makeText(
                    activity, R.string.location_access_rationale,
                    Toast.LENGTH_SHORT
                ).show()
                activity?.finish()
            }
    ...
    class RationaleDialog : DialogFragment() {
        ...
        override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
            ...
            finishActivity =
                arguments?.getBoolean(ARGUMENT_FINISH_ACTIVITY) ?: false
            return AlertDialog.Builder(activity)
                .setMessage(getString(R.string.location_access_rationale))
        ...
        override fun onDismiss(dialog: DialogInterface) {
            ...
            if (finishActivity) {
                Toast.makeText(
                    activity,
                    R.string.location_access_rationale,
                    Toast.LENGTH_SHORT
                ).show()
                activity?.finish()
            }
